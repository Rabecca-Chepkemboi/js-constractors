...
class Car {
  constructor(make, model, year, isAvaible) {
    this.make = make;
    this.model = model;
    this.year = year;
...
let car = new Car("Benz", "vuzula", 2020, false);
console.log({car});
...
let rental = new Rental("car", "chep", 2, 29);
console.log(rental);
...
let new_rental = new Car("car", "chep", 2, 29);
...
let end = new Rental2("car", "chep", 3, 15);
console.log(end);
...
const myQuestion = new Question("What is the capital of Kenya?", ["Paris", "London", "Nirobi", "Berlin"], "Paris");
